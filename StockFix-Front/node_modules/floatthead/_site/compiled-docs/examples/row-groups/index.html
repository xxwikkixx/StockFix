...
<li class='active'><a href='/floatThead/examples/row-groups/'>Row Groups & Using on IE</a></li>
...
<div class='row'>
    <div class='span12'>
        <h1>Colspans in TBODY</h1>
        <p>If you <strong>support IE</strong> and you have a table where the first visible row contains cells with colspans such as the example below,
        you will need to pass an additional configuration option to floatThead. <code>getSizingRow: function($table){...}</code>.
        </p>
        <p>
            <code>getSizingRow</code> should return a wrapped set of table cells within a table row. The length of the wrapped set should equal to the number of columns in the table.
            <br/>
            By default IE uses the first visible row for sizing, but in this example we cannot do that because the first visible row contains a single TD.
        </p>
        <br/><br/>
<div class="highlight"><pre><code class="language-js" data-lang="js"><span class="nx">$</span><span class="p">(</span><span class="kd">function</span><span class="p">(){</span>
    <span class="nx">$</span><span class="p">(</span><span class="s1">&#39;#demo&#39;</span><span class="p">).</span><span class="nx">floatThead</span><span class="p">({</span>
        <span class="nx">scrollingTop</span><span class="o">:</span> <span class="nx">pageTop</span><span class="p">,</span>
        <span class="nx">getSizingRow</span><span class="o">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">$table</span><span class="p">){</span> <span class="c1">// this is only called when using IE</span>
            <span class="k">return</span> <span class="nx">$table</span><span class="p">.</span><span class="nx">find</span><span class="p">(</span><span class="s1">&#39;tbody tr:not(.grouping):visible:first&gt;*&#39;</span><span class="p">);</span>
        <span class="p">}</span>
    <span class="p">});</span>
<span class="p">});</span></code></pre></div>
        <br/>
            ...
            <table id='demo'>
                ...
                <tbody>
                <tr class="grouping">
                    <td colspan="4">some group or something</td>
                </tr>
                <tr>
                    <td>keyboard</td>
                    <th>boolean</th>
