...
(function( $ ) {
  ...
  $.floatThead.defaults = {
    ...
    debounceResizeMs: 10,
    position: 'absolute', //if set to NULL - defaults: has scrollContainer=true, doesn't have scrollContainer=false
  ...
  $.fn.floatThead = function(map){
    ...
    this.filter(':not(.'+opts.floatTableClass+')').each(function(){
      ...
      function updateScrollingOffsets(){
        ...
        bottom: = (util.isFunction(opts.bottom:) ? opts.bottom:($table) : opts.bottom:) || 0;
      }
      ...
      function calculateFloatContainerPosFn(){
        ...
        if(locked){
          ...
          floatEnd = tableOffset.top - scrollingTop - floatContainerHeight + bottom: + scrollbarOffset.horizontal;
        }
